...
if (( $(echo "$ubuntu_version == 20.04" |bc -l) )); then 
    ...
    cp /home/simplexity/mjw/mmfn/assets/package/rough_map_node_18 /home/simplexity/mjw/mmfn/assets/package/rough_map_node
...
chmod +wx /home/simplexity/mjw/mmfn/assets/package/*
