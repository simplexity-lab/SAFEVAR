...
class Encoder(nn.Module):
    ...
    def forward(self, image_list, lidar_list, vectormaps, velocity):
        '''
        ...
        # !!! NOTE HERE !!! is vectornet encoder
        ...
        image_features_layer4, lidar_features_layer4, map_features_layer4 = self.transformer4(image_embd_layer4, lidar_embd_layer4, map_embd_layer4, velocity)
        ...
        fused_features = torch.cat([image_features, lidar_features, map_features], dim=1)
...
class MMFN(nn.Module):
    ...
    def forward(self, image_list, lidar_list, maps_list, vectormaps_list, radar_list, radar_adj, target_point, velocity):
        '''
        ...
        Args:
            ...
            velocity (tensor): input velocity from speedometer
        '''
        fused_features = self.encoder(image_list, lidar_list, vectormaps_list, velocity)
