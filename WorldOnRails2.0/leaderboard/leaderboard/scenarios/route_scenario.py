...
class RouteScenario(BasicScenario):
    ...
    def _update_ego_vehicle(self, physics):
        """
        ...
        # -----------------------------------------------------------------------------------------
        if len(physics) != 0:
            front_left_wheel = carla.WheelPhysicsControl(tire_friction=physics[8], damping_rate=physics[9],
                                                         radius=physics[10],
                                                         max_brake_torque=physics[11])
            front_right_wheel = carla.WheelPhysicsControl(tire_friction=physics[8], damping_rate=physics[9],
                                                          radius=physics[10],
                                                          max_brake_torque=physics[11])
            rear_left_wheel = carla.WheelPhysicsControl(tire_friction=physics[8], damping_rate=physics[9],
                                                        radius=physics[10], max_brake_torque=physics[11])
            rear_right_wheel = carla.WheelPhysicsControl(tire_friction=physics[8], damping_rate=physics[9],
                                                         radius=physics[10],
                                                         max_brake_torque=physics[11])
            ...
            physics_control.max_rpm = physics[0]
            physics_control.moi = 1.0
            physics_control.damping_rate_full_throttle = physics[1]
            physics_control.damping_rate_zero_throttle_clutch_engaged = physics[2]
            physics_control.damping_rate_zero_throttle_clutch_disengaged = physics[3]
            physics_control.use_gear_autobox = True
            physics_control.gear_switch_time = physics[4]
            physics_control.clutch_strength = physics[5]
            physics_control.mass = physics[6]
            physics_control.drag_coefficient = physics[7]
        ...
        # front_left_wheel = carla.WheelPhysicsControl(tire_friction=physics[8], damping_rate=physics[9],
        #                                              radius=physics[10],
        #                                              max_brake_torque=physics[11], max_handbrake_torque=0,
        #                                              lat_stiff_max_load=3.000000, lat_stiff_value=20.000000,
        ...
        # rear_left_wheel = carla.WheelPhysicsControl(tire_friction=physics[8], damping_rate=physics[9],
        #                                             radius=physics[10], max_brake_torque=physics[11],
        #                                             max_handbrake_torque=1600, lat_stiff_max_load=3.000000,
        #                                             lat_stiff_value=20.000000, long_stiff_value=3000.000000)
        # rear_right_wheel = carla.WheelPhysicsControl(tire_friction=physics[8], damping_rate=physics[9],
        #                                              radius=physics[10],
        #                                              max_brake_torque=physics[11], max_handbrake_torque=1600,
        #                                              lat_stiff_max_load=3.000000, lat_stiff_value=20.000000,
        #                                              long_stiff_value=3000.000000)
        # # -----------------------------------------------------------------------------------------
        ...
        # ego_vehicle.set_target_velocity(Vector3D(x=-10, y=0.060257, z=0.000008))aaaa
    ...
    def _initialize_actors(self, config):
        ...
        # if config.town == 'Town03':
        #     vehicle_bp = CarlaDataProvider._blueprint_library.find('vehicle.tesla.model3')
        #     spawn_point_one = Transform(Location(x=28.954424, y=207.569397, z=0.275307), Rotation(pitch=0.086354, yaw=-0.681213, roll=-0.002136))
