...
class NoCrashEvalScenario(RouteScenario):
    ...
    def _set_route(self, hop_resolution=1.0):
        ...
        start = Transform(Location(x=225.010, y=195.3063, z=0.0333), Rotation(pitch=0.005, yaw=-179.2628, roll=0.000))
        target = Transform(Location(x=188.3134, y=195.4802, z=0.033), Rotation(pitch=0.000, yaw=-179.3134, roll=-0.00))
    ...
    def _initialize_actors(self, config):
        ...
        if self.town_name == 'Town01' and car_amount == 0 and ped_amount == 0:
            ...
            spawn_point_one = Transform(Location(x=210.670166, y=190.148956, z=0.30000))
