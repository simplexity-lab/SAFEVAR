...
class ObjectState:
    def __init__(self, transform=None, velocity=None, angular_velocity=None, mass=None, tip=None, wheel_mass=None,
                 wheel_radius=None, MaxMotorTorque=None, MaxBrakeTorque=None, MinRPM=None, MaxRPM=None, ShiftTime=None,
                 TireDragCoeff=None, WheelDamping=None, TractionControlSlipLimit=None, MaxSteeringAngle=None):
        ...
        if tip is None:
            tip = 1025
        if wheel_mass is None:
            wheel_mass = 1025
        if wheel_radius is None:
            wheel_radius = 1025
        if MaxMotorTorque is None:
            MaxMotorTorque = 1025
        if MaxBrakeTorque is None:
            MaxBrakeTorque = 1025
        if MaxSteeringAngle is None:
            MaxSteeringAngle = 1025
        if MinRPM is None:
            MinRPM = 1025
        if MaxRPM is None:
            MaxRPM = 1025
        if ShiftTime is None:
            ShiftTime = 1025
        if TireDragCoeff is None:
            TireDragCoeff = 1025
        if WheelDamping is None:
            WheelDamping = 1025
        if TractionControlSlipLimit is None:
            TractionControlSlipLimit = 1025
        ...
        self.TractionControlSlipLimit = TractionControlSlipLimit
        self.WheelDamping = WheelDamping
        self.TireDragCoeff = TireDragCoeff
    ...
    def to_json(self):
        return {
            ...
            "MaxBrakeTorque": self.MaxBrakeTorque,
            "MinRPM": self.MinRPM,
            "MaxRPM": self.MaxRPM,
            "ShiftTime": self.ShiftTime,
            "TireDragCoeff": self.TireDragCoeff,
            "WheelDamping": self.WheelDamping,
            "TractionControlSlipLimit": self.TractionControlSlipLimit,
        ...
        return str(
            {
                ...
                "mass": str(self.mass),
                "tip": str(self.tip),
                "wheel": str(self.wheel_mass),
                "wheel_radius": str(self.wheel_radius),
                "MaxMotorTorque": str(self.MaxMotorTorque),
                "MaxBrakeTorque": str(self.MaxBrakeTorque),
                "MinRPM": str(self.MinRPM),
                "MaxRPM": str(self.MaxRPM),
                "ShiftTime": str(self.ShiftTime),
                "TireDragCoeff": str(self.TireDragCoeff),
                "WheelDamping": str(self.WheelDamping),
                "TractionControlSlipLimit": str(self.TractionControlSlipLimit),
                "MaxSteeringAngle": str(self.MaxSteeringAngle),
            }
        )
